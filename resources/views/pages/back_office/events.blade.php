                                    ...
                                    @foreach ($events as $event)
                                        <tr
                                            ...
                                            <td class="px-4 py-3 text-xs text-center">
                                                ...
                                                <button data-modal-target="crud-modal-{{$event->id}}"
                                                        data-modal-toggle="crud-modal-{{$event->id}}"
                                        ...
                                        {{--  <div id="crud-modal-{{$event->id}}" tabindex="-1" aria-hidden="true"
                                              ...
                                              <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                      ...
                                                      <form action="{{ route('events.update') }}" method="put"
                                                          ...
                                                          <div class="grid gap-4 mb-4 grid-cols-1">
                                                              ...
                                                              <div class="sm:col-span-1">
                                                                  ...
                                                                  <select name="location" id="location"
                                                                      ...
                                                                      <option value="{{$event['location']['$id']}}" selected
                                                                              disabled hidden>{{$event['location']['location']}}
                                                                      </option>
                                                              ...
                                                              <div class="sm:col-span-1">
                                                                  ...
                                                                  <select name="category" id="category"
                                                                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                                                      <option value="{{$event['category']['id']}}" selected disabled hidden>{{$event['category']['category']}}
                                                                      </option>
                ...
                <div class="grid gap-4 mb-4 grid-cols-1">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <select name="validation" id="location"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option value="{{old('validation')}}" selected disabled hidden>Choose Validation Option here</option>
