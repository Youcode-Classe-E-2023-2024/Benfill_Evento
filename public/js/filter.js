...
const homeCards = cardsSection.innerHTML;
const url = window.location.href;
const loaderHtml = `  <div class="relative p-4 w-full bg-white rounded-lg overflow-hidden shadow hover:shadow-md rounded-lg">
...
$(document).ready(function () {
    $('.categorySelect').on('click', function () {
        ...
        $.ajax({
            ...
            beforeSend: () => {
                cardsSection.innerHTML = loaderHtml;
            },
